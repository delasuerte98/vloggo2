...
export default function RegisterScreen({ navigation }: Props) {
  ...
  return (
    // ✅ Wrapper scrollabile + gestione tastiera/safe area ovunque
    <ScreenContainer withScroll headerHeight={0} keyboardOffset={Platform.select({ ios: 8, android: 0 }) as number}>
      <View style={styles.content}>
        ...
        {/* piccolo spazio per evitare sovrapposizione con la tastiera/bottom inset */}
